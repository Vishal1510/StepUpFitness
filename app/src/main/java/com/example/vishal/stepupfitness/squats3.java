 ...
 */
public class squats3 extends AppCompatActivity {
    private ArrayList<DataProvider> getData()
    {
        ...
        DataProvider squat2= new DataProvider("STIFF-LEGGED BARBELL DEADLIFT | 1 set of 15 reps ");
        ...
        DataProvider squat3=new DataProvider("BENT-ARM BARBELL PULLOVER | 1 set of 20 reps ");
        ...
        DataProvider sqaut4=new DataProvider("DIPS - CHEST VERSION| 2 sets of 10 reps");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CustomListViewAdapter adapter= new CustomListViewAdapter(squats3.this, data);
