 ...
 */
public class squats2 extends AppCompatActivity {

    private ArrayList<DataProvider> getData()
    {
        DataProvider squat1= new DataProvider("BARBELL BENCH PRESS - MEDIUM GRIP | 2-3 sets of 12 reps");
        ...
        DataProvider squat2= new DataProvider("BENT OVER BARBELL ROW | 2-3 sets of 12 reps");
        ...
        DataProvider squat3=new DataProvider("STANDING MILITARY PRESS | 3 sets of 6-8 reps");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CustomListViewAdapter adapter= new CustomListViewAdapter(squats2.this, data);
