...
public class abs2 extends AppCompatActivity {
    ...
    private ArrayList<DataProvider> getData(){
        DataProvider DeclineReverseCrunch= new DataProvider("Decline Reverse Crunch| 3 sets to failure, 2-minute rest");
        ...
        DataProvider SmithMachineBentOverRow=new DataProvider("Smith Machine Bent Over Row | 4 sets, 10 reps, 2-minute rest ");
        ...
        DataProvider Pullups = new DataProvider("Pullups | 4 sets to failure, 2-minute rest ");
        ...
        DataProvider StraightArmDumbellPullOver = new DataProvider("Straight Arm Dumbell Pull Over| 3 sets, 12 reps, 2-minute rest");
        ...
        DataProvider Hyperextensions = new DataProvider("Hyperextensions Weighted |3 sets to failure, 2-minute rest");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CustomListViewAdapter adapter = new CustomListViewAdapter(abs2.this, data);
