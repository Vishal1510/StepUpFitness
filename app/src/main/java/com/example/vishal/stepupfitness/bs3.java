 ...
 */
public class bs3 extends AppCompatActivity{
    private ArrayList<DataProvider> getData()
    {
        DataProvider arm1= new DataProvider("Standing Dumbell Reverse Curl | 3 sets of 6-8 reps");
        arm1.exercise.add("To begin, stand straight with a dumbbell in each hand using a pronated grip (palms facing down). Your arms should be fully extended while your feet are shoulder width apart from each other. This is the starting position.\n" +
        ...
        DataProvider arm2= new DataProvider("Hammer Curls | 3 sets of 6-8 reps");
        arm2.exercise.add("Stand up with your torso upright and a dumbbell on each hand being held at arms length. The elbows should be close to the torso.\n" +
        ...
        DataProvider arm3=new DataProvider("EZ Bar Curl | 3 sets of 6-8 reps");
        arm3.exercise.add("Stand up straight while holding an EZ curl bar at the wide outer handle. The palms of your hands should be facing forward and slightly tilted inward due to the shape of the bar. Keep your elbows close to your torso. This will be your starting position.\n" +
        ...
        DataProvider arm4=new DataProvider("Reverse Grips Triceps Pushdown | 3 sets of 6-8 reps");
        arm4.exercise.add("Start by setting a bar attachment (straight or e-z) on a high pulley machine.\n" +
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CustomListViewAdapter adapter= new CustomListViewAdapter(bs3.this, data);
